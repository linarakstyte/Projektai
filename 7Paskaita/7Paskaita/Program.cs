...
namespace _7Paskaita
{
    class Program
    {
        ...
        //{
        //    public List<int> PirmasSemestras;
        //    public List<int> AntrasSemestras;
        //    public List<int> TreciasSemestras;


        //    public Mokinys(List<int> pirmasSemetras, List<int> antrasSemetras, List<int> treciasSemetras)
        //    {
        ...
        //    {
        //        Mokinys mokinys = new Mokinys { (5, 7, 8, 5),(8, 6, 8, 9),(5, 6, 3, 6) };
